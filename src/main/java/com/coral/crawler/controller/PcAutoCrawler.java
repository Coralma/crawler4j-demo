 ...
 */
public class PcAutoCrawler extends WebCrawler {

    private Gson gson = new Gson();
    private PcAutoService service;

    public PcAutoCrawler() {
        initDao();
    }

    public PcAutoCrawler(String test) {
    }
    /**
    ...
    public boolean shouldVisit(Page referringPage, WebURL url) {
        ...
        boolean rs = href.startsWith("http://price.pcauto.com.cn/sg");
